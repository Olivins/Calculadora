package alunoangoti.com.calculadora;
        ...
        switch (tecla.getText().toString()) {
                ...
                if (operador != null && visor.getText().length() > 0) {
                    ...
                    switch (operador) {
                        case "/":
                            ...
                            total = Integer.parseInt(visor.getText().toString());
                            break;
                        case "*":
            ...
            case "M":
                if (operador.toString() == "="){
                    visor.setText(getString(R.string.total) + total);
                    break;
                }else{
                    visor.setText("");
                    break;
